...
{
	global $con;
	$row = mysqli_fetch_assoc(mysqli_query($con,"Select * from se_user where user_username = '$_SESSION[bvr]'"));
...
function mainmenu($ispages)
{
	...
	global $con;
	$user = mysqli_fetch_assoc(mysqli_query($con,"Select user_id from se_user where user_username = '$_SESSION[bvr]'"));
	...
	?>
        ...
        <li class="header" STYLE = "font-size:12px;text-align:center;">MANAGEMENT INFORMATION SYSTEM</li>
	   <?php
	    $ctr = 1;
