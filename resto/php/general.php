...
{
	global $con;
	$string = "Select * from  pos_sales_detail,pos_sales,se_user where pos_sales_detail.isdeleted = 0 
	and se_user.user_id = pos_sales_detail.created_by and pos_sales_detail.addon_id = 0 and pos_sales_detail.discount = 0
	and pos_sales.pos_sales_id = pos_sales_detail.pos_sales_id and pos_sales_detail.finalize = 1
	and pos_sales.order_count != 0 ";

	if($status != 0)
		$string = $string." and pos_sales_detail.done = $status ";
	
	$string = $string." order by pos_sales.order_count";
	...
	<table class = "table table-bordered table-hover table-xs" id = "ordertable">
			...
			while($row = mysqli_fetch_assoc($query))
			{
				...
				$var = mysqli_fetch_assoc(mysqli_query($con,"Select * from lup_variations where variation_id = $row[variation_id]"));
				?>
				<tr>
					<?PHP
								IF($print == 0)
														...
														function(e)
														{
															...
															if(r == true)
															{
																$.post( 
																	'php/pos.php',
																	{
																		mready:<?php echo $row['pos_sales_detail_id'];?>,
														...
														function(e)
														{
															...
															if(r == true)
															{
																$.post( 
																	'php/pos.php',
																	{
																		mserved:<?php echo $row['pos_sales_detail_id'];?>,
					...
					<td><?php echo $otype['order_type_description'];?></td>
...
{
	global $con;
	$string = "Select * from  pos_sales_detail,pos_sales,se_user where pos_sales_detail.isdeleted = 0 and pos_sales_detail.done = 1
	and se_user.user_id = pos_sales_detail.created_by and pos_sales_detail.addon_id = 0 and pos_sales_detail.discount = 0
	and pos_sales.pos_sales_id = pos_sales_detail.pos_sales_id and pos_sales_detail.finalize = 1
	...
	<table class = "table table-bordered table-hover table-xs">
			...
			while($row = mysqli_fetch_assoc($query))
			{
				...
				<tr>
					...
					<tH><?php echo $row['order_count'];?></th>
					<th><?php echo $otype['order_type_description'];?></th>
					<tH><?php echo $row['created_modified'];?></th>
