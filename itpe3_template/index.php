...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="home.php" class="logo" >
      ...
      <span class="logo-mini">TGH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">TITLE GOES HERE</span>
    </a>
 ...
 <aside class="main-sidebar" style = "background-color:<?php echo $sidebar;?>;">
    ...
    <section class="sidebar" >
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview">
				 <a href="#" id = "menu1">
					<i class="fa fa-arrow-circle-right"></i> <span>MENU 1</span>
				  </a>
				 
			</li>
			<li class="treeview">
				   <a href="#" id = "menu2">
					<i class="fa fa-arrow-circle-right"></i> <span>MENU 2</span>
				  </a>
			</li>
			<li class="treeview">
				   <a href="#" id = "menu3">
					<i class="fa fa-arrow-circle-right"></i> <span>MENU 3</span>
				  </a>
			</li>
